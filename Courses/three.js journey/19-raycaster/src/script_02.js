...
const tick = () =>
{
    ...
    object2.position.x = Math.sin(elapsedTime * -1) * 1.5;
    object2.position.y = Math.cos(elapsedTime * -1) * 1.5;
    
    object3.position.x = (Math.sin(elapsedTime * 3) * 0.4) + object2.position.x;
    object3.position.y = (Math.cos(elapsedTime * 3) * 0.4) + object2.position.y;
