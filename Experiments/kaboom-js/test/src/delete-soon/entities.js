import { scale } from '../js/constants';
...
export function makeInhalable(k, enemy) {
...
export function makeFlameEnemy(k, posX, posY) {
  const flame = k.add([
...
export function makeGuyEnemy(k, posX, posY) {
  const guy = k.add([
...
export function makeBirdEnemy(k, posX, posY, speed) {
  const bird = k.add([
